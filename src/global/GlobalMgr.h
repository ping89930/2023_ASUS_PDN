...
class GlobalMgr {
    public:
        ...
        bool checkWithVias(int netId, int layerId, OASGNode* a, OASGNode* b, vector<vector<vector<OASGNode*>>> viaOASGNodes, vector<vector<OASGNode*> > obstacle, size_t viaNetId, size_t viaId);
        ...
        void connectWithVia(int netId, int layerId,OASGNode* a, OASGNode* b, vector<vector<OASGNode*> > ViaCluster, vector<vector<OASGNode*> > obstacle, size_t const viaNetId, size_t const viaId);
